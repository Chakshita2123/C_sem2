// Square Pattern printing with loops
// #include <stdio.h>
// int main() {
//     int rows,cols;
...
// #include <stdio.h>
// int main() {
//     int n = 6;     //define the size of the pattern
//     for (int i=1;i<=n;i++)      //for rows
//     {
//         for (int j=1;j<=n;j++)     //for columns
//         {
//             printf("%-5d",i*j);     //-5d for spacing in the result
//         }
...
//Write a program to count the digits in the number entered and the reverse of the number entered
// #include <stdio.h>
// int main() {
